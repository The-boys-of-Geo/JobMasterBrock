...
import { HeaderContext } from '../pages/JobPage';
...
export const SearchBar: React.FC = () => {
  ...
  const [searchOnsiteRemote, setSearchOnsiteRemote] =
    useState<string>('Remote');
  const { handleSearchSubmit } = useContext(HeaderContext);
  ...
  return (
    <div className="SearchBar">
      ...
      >
        ...
        <select
          className="Input"
          name="searchDatePosted"
          value={searchDatePosted}
        ...
        <select
          className="Input"
          name="searchOnsiteRemote"
          value={searchOnsiteRemote}
          onChange={handleDropdownChange}
        >
